...
function Navbar() {
  return (
    <nav className="flex items-center justify-between py-4 px-10 top-0 bg-rgba(255, 255, 255, 0.1) backdrop-blur-md text-gold z-100 fixed w-full font-bold text-sm">
      <div>
